...
```{r}
#| label: Data preparation and cleaning
...
**1. Which scientific domains saw the highest termination rates?**
...
Hypothesis: I expect directorates relating to climate change and STEM research to be most affected at the outset of the cancellations.

**2. Were terminations clustered by geography or institution type?**
